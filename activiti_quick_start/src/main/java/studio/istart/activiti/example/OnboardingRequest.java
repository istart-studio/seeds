...
public class OnboardingRequest {
    public static void main(String[] args) throws ParseException {
        ...
        runProcessInstance(processEngine, processDefinition);
    }

    public static void runProcessInstance(ProcessEngine processEngine, ProcessDefinition processDefinition) throws ParseException {
        //运行时服务
        RuntimeService runtimeService = processEngine.getRuntimeService();
        //根据[实例ID]启动进程实例
        //todo:[实例ID]
        String processKey = "onboarding";
